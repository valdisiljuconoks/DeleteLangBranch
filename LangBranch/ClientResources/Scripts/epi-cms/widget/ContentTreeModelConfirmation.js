            ...
            aspect.around(model, "pasteItem", function(originalMethod) {
                return function(source, oldParent, newParent, copy, sortIndex) {
                    ...
                    if (newParent.isWastebasket) {
                        ...
                        // Plain move
                        confirmation = _showConfirmation(moveTitle, TypeDescriptorManager.getResourceValue(source.typeIdentifier, "moveconfirmation"));
                    ...
                    return when(confirmation, function() {
                        ...
                        var result = originalMethod.apply(model, pasteArguments);
                        result.otherwise(function(callbackOrError) {
                            alert("asdf");
                        });
                        return result;
